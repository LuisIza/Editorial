        ...
        <div class="col s6 l2 m4">
            <div class="card hoverable">
                ...
                <div id ="codigos" class="card-action">
                    ...
                    <p class="lprecio">Gratis</p>
                       
                    <%}else if(lp.getDigital().doubleValue() > 0 && lp.getImpreso().doubleValue()> 0){%>
                        <p class="txtprecio">Tapa blanda</p>
                        <p class="lprecio"><%=lp.getImpreso()%> €</p>
                    <%}else if(lp.getDigital().doubleValue() > 0 && lp.getImpreso().doubleValue()< 0){%>
                        <p class="txtprecio">Solo digital</p>
                        <p class="lprecio"><%=lp.getDigital()%> €</p>
                    <%}else{%>
                        <p class="txtprecio">Tapa blanda</p>
                        <p class="lprecio"><%=lp.getImpreso()%> €</p>
                    <%}%>
