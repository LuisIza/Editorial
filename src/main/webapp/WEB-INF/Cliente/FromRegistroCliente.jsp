        ...
        <form class="card" action="ServletGuardarUser" method="post">
            ...
            <div class="card-content ">
                ...
                <div class='row black-text'>
                    <div class="input-field col s12 ">
                        <!--<i class="material-icons prefix">account_circle</i>-->
                        <input class='validate black-text ' type='text' name='permisos' id='permisos' value="Cliente" hidden />
                ...
                <div class="row">
                    ...
                    <button class="btn waves-effect waves-light blue-grey darken-1" type="button" id="salir"onclick="window.location.href='ControladorBotones?nom=cliente';">Cancelar<i class="material-icons right">close</i> </button>
                </div>
            </div>


            <% if (request.getAttribute("error") != null) {%>
            <div><h5 class="center-align"><%= (String) request.getAttribute("error")%></h5></div>
