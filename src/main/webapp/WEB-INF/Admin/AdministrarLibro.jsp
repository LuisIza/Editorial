                ...
                <div class="card-stacked">
                    ...
                    <div class="card-action">
                        ...
                        <% } else { %>
                            ...
                            <a class="btn hoverable red" target="_blank" href="http://localhost:8080/EditorialAragon/upload/<%=ar.getUrlArchivo()%>"><i class="material-icons right">cloud_download</i>Abrir el documento</a>
                            <a class="btn hoverable" target="_blank" href="http://localhost:8070/ED/upload/<%=ar.getUrlArchivo()%>"><i class="material-icons right">cloud_download</i>Abrir el documento</a>
                        ...
                        <a onclick="publicar(<%=libro.getId()%>);" class="btn-floating red darken-1 hoverable hide-on-large-only" ><i class="material-icons right">sync</i>Aceptar publicación</a>
                        <a onclick="publicar(<%=libro.getId()%>);" class="btn red darken-1 hoverable hide-on-med-and-down" ><i class="material-icons right">sync</i>Aceptar publicación</a>
                        <a href="ControladorBotones?nom=administrar" class="btn blue-grey darken-1 hoverable right" ><i class="material-icons right">close</i>Salir</a>
                        <br>
                        <br>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function msg(id) {
        ...
        var opcion = confirm("Esta apundo de publicar el libro \nDesea continuar?");
        if (opcion === true) {
            window.location.href = "ActualizarDatosLibro?act=on";
        }
    }
    ...
    function borrarArchivo(id) {
        ...
        if (opcion == true) {
            window.location.href = "BorrarArchivo?idd=" + id;
        }
    }
