    ...
    <div class="col l6 offset-l3 s12 m10 offset-m1">
        <form class="card" action="ServletLogin" method="post">
            <div class="card-action blue-grey darken-1 	white-text">
                <h4 class="center-align">ACCESO A GESTION</h4>
            ...
            <div class="card-content ">
                ...
                <div class='row black-text'>
                    <div class="input-field col s12 ">
                        <!--<i class="material-icons prefix">account_circle</i>-->
                        <input class='validate black-text ' type='text' name='tipo' id='tipo' value="adm" hidden />
            ...
            <div class="row">
                <div class="col l10 offset-l1">
                    <p class="margin">Si aun no estas registrado crea tu cuenta ahora... <a href="ControladorBotones?nom=cuentadmin">aqui</a></p>
                </div>
