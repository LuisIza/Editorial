 ...
 * @author WEB1
 */
@WebServlet(name = "GuardarDocumentos", urlPatterns = {"/GuardarDocumentos"})
public class GuardarDocumentos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String uploadFolder = getServletContext().getRealPath("") + File.separator + "upload"; //Archivos Server
        ...
        LibroPublicadoEa libro = (LibroPublicadoEa) session.getAttribute("NuevoLibro");
            ...
            try {
                ...
                ArchivosLibroEa archivo = new ArchivosLibroEa();
                archivo.setIdPublicidad(libro);
                archivo.setFechaAlta(date);
                archivo.setNombre((String) list.get(0));
                archivo.setTipoArchivo(tipo);
                archivo.setUrlArchivo((String) list.get(1));

                ArchivosCRUD.create(archivo);
