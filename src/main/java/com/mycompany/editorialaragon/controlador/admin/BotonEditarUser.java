 ...
 * @author WEB1
 */
@WebServlet(name = "BotonEditarUser", urlPatterns = {"/BotonEditarUser"})
public class BotonEditarUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        UsuariosEa us= UserCRUD.findUserEmail(id);
            ...
            request.setAttribute("modificar", us);
            request.setAttribute("accion","Admin/ModificarUser");
            rd.forward(request, response);
